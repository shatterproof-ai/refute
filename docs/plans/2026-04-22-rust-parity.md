...
Append to `docs/plans/2026-04-22-rust-parity-log.md` under "Deviations from the Plan" (or a new "Task 0 Findings" section — add it at the top if absent):
...
```bash
git add testdata/fixtures/rust/rename/src/lib.rs docs/plans/2026-04-22-rust-parity-log.md
...
**Branch selection:** read Task 0's entry in `docs/plans/2026-04-22-rust-parity-log.md`. If it records "cheap", follow Steps 1-4. If "expensive", follow Steps 1-4 then Steps 5-8 additionally.
...
Append to `docs/plans/2026-04-22-rust-parity-log.md`:
...
```bash
git add docs/plans/2026-04-22-rust-parity-log.md
