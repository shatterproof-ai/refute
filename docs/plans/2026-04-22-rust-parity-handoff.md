...
**Plan:** `docs/plans/2026-04-22-rust-parity.md`
**Spec:** `docs/specs/2026-04-22-rust-parity-design.md`
**Progress log:** `docs/plans/2026-04-22-rust-parity-log.md`
...
>
> 1. Read `docs/plans/2026-04-22-rust-parity-handoff.md` in full.
> 2. Read `docs/plans/2026-04-22-rust-parity-log.md` — especially the Status Dashboard, Task 0 Findings, Deviations, and most recent Session Entry.
> 3. Read `docs/plans/2026-04-22-rust-parity.md` for the task you're about to work on.
>
